...
import 'package:study/p29BottomNavigationBar/pages/tabs/category.dart';
...
import 'package:study/p29BottomNavigationBar/pages/tabs/settting.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          //选中颜色
          type:BottomNavigationBarType.fixed,//允许底部显示多个按钮 默认只能显示三个按钮
          ...
          items: [
            ...
            BottomNavigationBarItem(
                ...
                title: Text("个人 ",textAlign: TextAlign.center,)),
          ],
        ));
  }
}
